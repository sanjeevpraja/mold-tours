...
function create_member_post_type() {
    $labels = array(
        'name'                  => _x('Members', 'Post Type General Name', 'wp-mold'),
        'singular_name'         => _x('Member', 'Post Type Singular Name', 'wp-mold'),
        'menu_name'             => __('Members', 'wp-mold'),
        'name_admin_bar'        => __('Member', 'wp-mold'),
        'archives'              => __('Member Archives', 'wp-mold'),
        'attributes'            => __('Member Attributes', 'wp-mold'),
        'parent_item_colon'     => __('Parent Member:', 'wp-mold'),
        'all_items'             => __('All Members', 'wp-mold'),
        'add_new_item'          => __('Add New Member', 'wp-mold'),
        'add_new'               => __('Add New', 'wp-mold'),
        'new_item'              => __('New Member', 'wp-mold'),
        'edit_item'             => __('Edit Member', 'wp-mold'),
        'update_item'           => __('Update Member', 'wp-mold'),
        'view_item'             => __('View Member', 'wp-mold'),
        'view_items'            => __('View Members', 'wp-mold'),
        'search_items'          => __('Search Member', 'wp-mold'),
    ...
    $args = array(
        'label'                 => __('Member', 'wp-mold'),
        'description'           => __('Member information', 'wp-mold'),
        'labels'                => $labels,
...
function member_details_callback($post) {
    ...
    <table class="form-table" role="presentation">
        <tbody>
            <tr>
                <th scope="row"><label for="member_designation"><?php _e('Designation', 'wp-mold'); ?></label></th>
            ...
            <tr>
                <th scope="row"><label for="member_gender"><?php _e('Gender', 'wp-mold'); ?></label></th>
                <td>
                    <select id="member_gender" name="member_gender">
                        <option value=""><?php _e('Select Gender', 'wp-mold'); ?></option>
                        <option value="male" <?php selected($gender, 'male'); ?>><?php _e('Male', 'wp-mold'); ?></option>
                        <option value="female" <?php selected($gender, 'female'); ?>><?php _e('Female', 'wp-mold'); ?></option>
                        <option value="other" <?php selected($gender, 'other'); ?>><?php _e('Other', 'wp-mold'); ?></option>
                    </select>
                </td>
            </tr>
            <tr>
                <th scope="row"><label for="member_university"><?php _e('University', 'wp-mold'); ?></label></th>
                <td><input type="text" id="member_university" name="member_university" value="<?php echo esc_attr($university); ?>" class="regular-text" /></td>
            </tr>
            <tr>
                <th scope="row"><label for="member_campus_department"><?php _e('Campus/Department', 'wp-mold'); ?></label></th>
            ...
            <tr>
                <th scope="row"><label for="member_academic_degree"><?php _e('Academic Degree', 'wp-mold'); ?></label></th>
            ...
            <tr>
                <th scope="row"><label for="member_completed_year"><?php _e('Completed Year', 'wp-mold'); ?></label></th>
            ...
            <tr>
                <th scope="row"><label for="member_thesis_title"><?php _e('Thesis Title', 'wp-mold'); ?></label></th>
            ...
            <tr>
                <th scope="row"><label for="member_linkedin"><?php _e('LinkedIn', 'wp-mold'); ?></label></th>
            ...
            <tr>
                <th scope="row"><label for="member_twitter"><?php _e('Twitter', 'wp-mold'); ?></label></th>
            ...
            <tr>
                <th scope="row"><label for="member_facebook"><?php _e('Facebook', 'wp-mold'); ?></label></th>
...
function member_admin_columns($columns) {
    ...
    $new_columns['university'] = __('University', 'wp-mold');
    $new_columns['degree'] = __('Degree', 'wp-mold');
    $new_columns['email'] = __('Email', 'wp-mold');
...
function display_member_info($post_id = null) {
    ...
    $fields = array(
        'designation' => __('Designation', 'wp-mold'),
        'gender' => __('Gender', 'wp-mold'),
        'university' => __('University', 'wp-mold'),
        'campus_department' => __('Campus/Department', 'wp-mold'),
        'academic_degree' => __('Academic Degree', 'wp-mold'),
        'completed_year' => __('Completed Year', 'wp-mold'),
        'thesis_title' => __('Thesis Title', 'wp-mold'),
        'supervisor' => __('Supervisor', 'wp-mold'),
        'phone' => __('Phone', 'wp-mold'),
        'email' => __('Email', 'wp-mold'),
        'website' => __('Website', 'wp-mold'),
        'linkedin' => __('LinkedIn', 'wp-mold'),
        'twitter' => __('Twitter', 'wp-mold'),
        'facebook' => __('Facebook', 'wp-mold')
    );
